...
html_parts = [
    ...
    '</div></div>',
    '<footer class="footer"><strong>ADADD</strong> · 广告行业资讯聚合平台 · Developed with ❤️ by nelsonmeng</footer>',
